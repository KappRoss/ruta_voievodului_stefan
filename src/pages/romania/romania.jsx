			...
			<div className="romania-row">
				...
				<div className="romania-row-right">
					...
					{props.loc.text_1.map((key, i) => 
						<a href={props.loc.links_1[i]} target = '_blank' rel="noopener noreferrer">{key}<br/></a>
					)}
			...
			<div className="romania-row">
				<div className="romania-row-right romania-row-middle">
					...
					{props.loc.text_2.map((key, i) => 
						<a href={props.loc.links_2[i]} target = '_blank' rel="noopener noreferrer">{key}<br/></a>
					)}
				...
				<div className="romania-row-right romania-row-middle">
					...
					{props.loc.text_3.map((key, i) => 
						<a href={props.loc.links_3[i]} target = '_blank' rel="noopener noreferrer">{key}<br/></a>
					)}
				...
				<div className="romania-row-right romania-row-middle">
					...
					{props.loc.text_4.map((key, i) => 
						<a href={props.loc.links_4[i]} target = '_blank' rel="noopener noreferrer">{key}<br/></a>
					)}
			...
			<div className="romania-row">
				<div className="romania-row-right romania-row-bottom">
					...
					{props.loc.text_5.map((key, i) => 
						<a href={props.loc.links_5[i]} target = '_blank' rel="noopener noreferrer">{key}<br/></a>
					)}
				...
				<div className="romania-row-right romania-row-bottom">
					...
					{props.loc.text_6.map((key, i) => 
						<a href={props.loc.links_6[i]} target = '_blank' rel="noopener noreferrer">{key}<br/></a>
					)}
